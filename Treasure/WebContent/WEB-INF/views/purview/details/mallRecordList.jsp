...
<div id="member-list" class="bsplus-grid"
	data-url="${path}/transfer/mgr/showList2" data-sort-field="id"
			...
			<div class="grid-query">
				<form>
					<div class="form-group form-group-sm">
						...
						<div class="input-group">
							<span class="input-group-addon">用户状态</span><select name="mallStatus"
		...
		<div class="bsplus-table table-bordered">
			<div class="table-fields">
				...
				<div data-field="userName" data-common-cls="text-center"
					data-allow-sort="true" data-width="10%" data-fixed="left">会员名称</div>
				<div data-field="fullName" data-common-cls="text-center"
					data-allow-sort="true" data-width="10%" data-fixed="left">用户姓名</div>
				<div data-field="mallAddress" data-common-cls="text-center"
					data-allow-sort="true" data-width="10%">钱包地址</div>
				<div data-common-cls="text-center" data-field="mallIntegral"
					data-allow-sort="true" data-width="4%">智联币数</div>
				
				<div data-field="mallCreatetime" data-date-format="yyyy/MM/dd hh:mm:ss"
