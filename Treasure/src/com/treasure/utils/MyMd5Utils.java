 ...
 * @class MyMd5Utils.java
 * @author jiagui E-mail:<zhujiagui@zkingsoft.com>
 * @date 2015年9月9日 下午5:51:19
...
public class MyMd5Utils {
	...
	public MyMd5Utils(String input, String enc) {
		byte bytes[] = null;
		try {
	...
	public MyMd5Utils(String input) {
		this(input, "UTF8");
	}
	...
	public MyMd5Utils(InputStream in) {
		this.stringp = false;
		this.in = in;
		this.state = new int[4];
		this.buffer = new byte[64];
	...
	public void hmac_Md5(String text, String key) throws IOException {
		...
		if (key_len > 64) {
			key1 = new MyMd5Utils(key).getDigest();
			key_len = 16;
		}
	...
	public static String getMd5Value(String md5String, String md5Key) {
		MyMd5Utils md5 = new MyMd5Utils("");
		byte b[] = null;
		try {
			md5.hmac_Md5(md5String, md5Key.trim());
			b = md5.getDigest();
		} catch (Exception e) {
			e.printStackTrace();
		}
